...
export const siteConfig: SiteConfig = {
  title: "Wenxig",
  subtitle: "幻光灼灼✨无可敷衍",
  siteURL: "https://wenxig.github.io/", // 请替换为你的站点URL，以斜杠结尾
  ...
  bilibili: {
    vmid: "1979383452", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
  ...
  links: [
    ...
    // 支持自定义导航栏链接，支持多级菜单
    {
      ...
      children: [
        {
          name: "GitHub",
          url: "https://github.com/wenxig",
          external: true,
          icon: "fa7-brands:github",
        },
        {
          name: "Bilibili",
          url: "https://space.bilibili.com/1979383452",
          external: true,
...
export const commentConfig: CommentConfig = {
  ...
  twikoo: {
    envId: "https://wenxig-blog-comments.vercel.app",
    lang: SITE_LANG,
  },
}
